...
INTRO_TEXT = "  สวัสดีครับ ผมเป็นปัญญาประดิษฐ์ที่ชำนาญด้านการจัดจำแนกหอยศัตรูพืช กรุณาอัพโหลดรูปภาพศัตรูพืชที่ท่านสงสัย ผมจะช่วยจัดจำแนกให้"
...
def get_tts_html_script(snail_data, confidence_text, uploaded_file_exists):
    ...
    result_text_th1 = " ผล ผลการจัดจำแนกหอยศัตรูพืชจากรูป คาดว่าน่าจะเป็น"
    result_text_thainame = f"หอย {snail_data['thai_name'] + (snail_data['tokens'][1] if len(snail_data['tokens'])>1 else '')}"
    result_text_en = f" The The a {snail_data['sci_name_1'] + ' ' + snail_data['sci_name_2']}"
    ...
    result_text_th2 = f" ด้วย ด้วยมีความมั่นใจ {confidence_text}"
    result_text_introprotect = " หาก ถ้าหาก คุณอยากทราบข้อมูลเกี่ยวกับวิธีการป้องกันกำจัด กระผมสามารถให้ข้อมูลได้ โดยกดปุ่มป้องกัน กำจัดที่อยู่ด้านล่างสุดครับ"
