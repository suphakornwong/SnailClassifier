...
def process_snail_data(top_class_name):
    ...
    if first_token == "Parmarion_martensi":
        display_info = [" ทากเล็บมือนาง", " มีชื่อวิทยาศาสตร์คือ", " Parmarion", " martensi", " โดยจัดอยู่ในวงศ์", " Ariophantidae"]
        speech_protect = INFO_AMBER_SUBULI_MARTEN
        
    elif first_token == "Subulina_octona":
        display_info = [" หอยข้าวสารยอดมน", " มีชื่อวิทยาศาสตร์คือ", " Subulina", " octona", " โดยจัดอยู่ในวงศ์", " Subulinidae"]
        speech_protect = INFO_AMBER_SUBULI_MARTEN
        
    elif first_token == "Pila_sp":
        display_info = [" หอยโข่ง", " มีชื่อวิทยาศาสตร์ว่า", " Pila", " sp.", " จัดอยู่ในวงศ์", " โดยAmpullariidae"]
        speech_protect = INFO_PILA
        
    elif first_token == "Physella_acuta":
        display_info = [" หอยคันหอยบัวหรือหอยบ่อ", " มีชื่อวิทยาศาสตร์ว่า", " Physella", " acuta", " โดยจัดอยู่ในวงศ์", " Physidae"]
        speech_protect = INFO_OTHER_WATER_SNAIL
        
    elif first_token == "Radix_sp":
        display_info = [" หอยคัน หอยบัว หรือหอยบ่อ", " มีชื่อวิทยาศาสตร์ว่า", " Radix", " sp.", " โดยจัดอยู่ในวงศ์", " Lymnaeidae"]
        speech_protect = INFO_OTHER_WATER_SNAIL
        
    elif first_token == "Indoplanorbis_exustus":
        display_info = [" หอยคันหรือหอยคันอินโด", " มีชื่อวิทยาศาสตร์ว่า", " Indoplanorbis", " exustus", " โดยจัดอยู่ในวงศ์", " Bulinidae"]
        speech_protect = INFO_OTHER_WATER_SNAIL
        
    elif first_token == "Melanoides_tuberculata":
        display_info = [" หอยเจดีย์ลายเสือ", " มีชื่อวิทยาศาสตร์ว่า", " Melanoides", " tuberculata", " โดยจัดอยู่ในวงศ์", " Thiaridae"]
        speech_protect = INFO_OTHER_WATER_SNAIL
        
    elif first_token == "Allopeas_gracile":
        display_info = [" หอยเจดีย์เล็กหรือหอยข้าวสารธรรมดา", " มีชื่อวิทยาศาสตร์คือ", " Allopeas", " gracile", " โดยจัดอยู่ในวงศ์", " Subulinidae"]
        speech_protect = INFO_AMBER_SUBULI_MARTEN
        
    elif first_token == "Paropeas_sp":
        display_info = [" หอยเจดีย์ใหญ่", " มีชื่อวิทยาศาสตร์คือ", " The Paropeas", " sp.", " โดยจัดอยู่ในวงศ์", " Subulinidae"]
        speech_protect = INFO_AMBER_SUBULI_MARTEN
        
    elif first_token == "Pomacea_canaliculata":
        display_info = [" หอยเชอรี่", " มีชื่อวิทยาศาสตร์คือ", " Pomacea", " canaliculata", " โดยจัดอยู่ในวงศ์", " Ampullariidae"]
        speech_protect = INFO_CHERRY
        
    elif first_token == "Sarika_siamensis":
        display_info = [" หอยดักดาน หรือหอยทากสยาม", " มีชื่อวิทยาศาสตร์คือ", " Sarika", " siamensis", " โดยจัดอยู่ในวงศ์", " Ariophantidae"]
        speech_protect = INFO_SARIKA
        
    elif first_token == "Lissachatina_fulica":
        display_info = [" หอยทากยักษ์แอฟริกา", " มีชื่อวิทยาศาสตร์คือ", " Lissachatina", " fulica", " โดยจัดอยู่ในวงศ์", " Achatinidae"]
        speech_protect = INFO_LISSA
        
    elif first_token == "Ovachlamys_fulgens":
        display_info = [" หอยเลขหนึ่ง", " มีชื่อวิทยาศาสตร์คือ", " Ovachlamys", " fulgens", " โดยจัดอยู่ในวงศ์", " Helicarionidae"]
        speech_protect = INFO_JUMPING
        
    elif first_token == "Bradybaena_similaris":
        display_info = [" หอยสะดือบุ๋ม", " มีชื่อวิทยาศาสตร์ว่า", " Bradybaena", " similaris", " โดยจัดอยู่ในวงศ์", " Camaenidae"]
        speech_protect = INFO_BRADYBAENA
        
    elif first_token == "Sarika_resplendens":
        display_info = [" หอยสาริกา", " มีชื่อวิทยาศาสตร์คือ", " The Sarika", " resplendens", " โดยจัดอยู่ในวงศ์", " Ariophantidae"]
        speech_protect = INFO_SARIKA
        
    elif first_token == "Succinea_sp":
        display_info = [" หอยอำพัน", " มีชื่อวิทยาศาสตร์คือ", " Succinea", " sp.", " โดยจัดอยู่ในวงศ์", " Succineidae"]
        speech_protect = INFO_AMBER_SUBULI_MARTEN
        
    elif first_token == "Pomacea_maculata":
        display_info = [" หอยแอปเปิ้ลเกาะ", " มีชื่อวิทยาศาสตร์คือ", " Pomacea", " maculata", " โดยจัดอยู่ในวงศ์", " Ampullariidae"]
        speech_protect = INFO_CHERRY
