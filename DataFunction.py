...
INTRO_TEXT = "  สวัสดีค่ะ ฉันเป็นปัญญาประดิษฐ์ ที่ชำนาญด้านการจัดจำแนกหอยศัตรูพืช กรุณาอัพโหลดรูปภาพศัตรูพืชที่ท่านสงสัย ฉันจะช่วยจัดจำแนกให้"
...
แต่ขออภัยด้วย หอยชนิดนี้ยังไม่มีคำแนะนำอย่างเป็นทางการจากกรมวิชาการเกษตร ในการป้องกันและกำจัดค่ะ"""
...
INFO_NULL = """  ภาพดังกล่าวไม่ใช่หอยศัตรูพืชค่ะ จึงไม่สามารถจัดจำแนกได้"""
...
def get_tts_html_script(snail_data, confidence_text, uploaded_file_exists):
    ...
    if snail_data['tokens'][0] != "ไม่ใช่หอยศัตรูพืช":
        ...
        result_text_introprotect = " ถ้าหาก คุณอยากทราบข้อมูลเกี่ยวกับวิธีการป้องกันกำจัด ฉันสามารถให้ข้อมูลได้ โดยกดปุ่มป้องกัน กำจัดที่อยู่ด้านล่างสุดค่ะ"
    else:
        # กรณีที่เป็น Null (ไม่ใช่หอยศัตรูพืช) ให้พูดสั้นๆ
        result_text_th1 = " จากรูปภาพดังกล่าว ไม่ใช่หอยศัตรูพืชค่ะ"
