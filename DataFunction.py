...
def process_snail_data(top_class_name):
    ...
    if first_token == "Parmarion_martensi":
        display_info = [" ทากทากเล็บมือนาง", " มีชื่อวิทยาศาสตร์คือ", " The Parmarion", " martensi", " โดยจัดอยู่ในวงศ์", " Ariophantidae"]
        speech_protect = INFO_AMBER_SUBULI_MARTEN
        
    elif first_token == "Subulina_octona":
        display_info = [" หอยหอยข้าวสารยอดมน", " มีชื่อวิทยาศาสตร์คือ", " The Subulina", " octona", " โดยจัดอยู่ในวงศ์", " Subulinidae"]
        speech_protect = INFO_AMBER_SUBULI_MARTEN
        
    elif first_token == "Pila_sp":
        display_info = [" หอยหอยโข่ง", " มีชื่อวิทยาศาสตร์ว่า", " The Pila", " sp.", " จัดอยู่ในวงศ์", " โดยAmpullariidae"]
        speech_protect = INFO_PILA
        
    elif first_token == "Physella_acuta":
        display_info = [" หอยหอยคันหอยบัวหรือหอยบ่อ", " มีชื่อวิทยาศาสตร์ว่า", " The Physella", " acuta", " โดยจัดอยู่ในวงศ์", " Physidae"]
        speech_protect = INFO_OTHER_WATER_SNAIL
        
    elif first_token == "Radix_sp":
        display_info = [" หอยหอยคันหอยบัวหรือหอยบ่อ", " มีชื่อวิทยาศาสตร์ว่า", " The Radix", " sp.", " โดยจัดอยู่ในวงศ์", " Lymnaeidae"]
        speech_protect = INFO_OTHER_WATER_SNAIL
        
    elif first_token == "Indoplanorbis_exustus":
        display_info = [" หอยหอยคันหรือหอยคันอินโด", " มีชื่อวิทยาศาสตร์ว่า", " The Indoplanorbis", " exustus", " โดยจัดอยู่ในวงศ์", " Bulinidae"]
        speech_protect = INFO_OTHER_WATER_SNAIL
        
    elif first_token == "Melanoides_tuberculata":
        display_info = [" หอยหอยเจดีย์ลายเสือ", " มีชื่อวิทยาศาสตร์ว่า", " The Melanoides", " tuberculata", " โดยจัดอยู่ในวงศ์", " Thiaridae"]
        speech_protect = INFO_OTHER_WATER_SNAIL
        
    elif first_token == "Allopeas_gracile":
        display_info = [" หอยหอยเจดีย์เล็กหรือหอยข้าวสารธรรมดา", " มีชื่อวิทยาศาสตร์คือ", " The Allopeas", " gracile", " โดยจัดอยู่ในวงศ์", " Subulinidae"]
        speech_protect = INFO_AMBER_SUBULI_MARTEN
        
    elif first_token == "Paropeas_sp":
        display_info = [" หอยหอยเจดีย์ใหญ่", " มีชื่อวิทยาศาสตร์คือ", " The Paropeas", " sp.", " โดยจัดอยู่ในวงศ์", " Subulinidae"]
        speech_protect = INFO_AMBER_SUBULI_MARTEN
        
    elif first_token == "Pomacea_canaliculata":
        display_info = [" หอยหอยเชอรี่", " มีชื่อวิทยาศาสตร์คือ", " The Pomacea", " canaliculata", " โดยจัดอยู่ในวงศ์", " Ampullariidae"]
        speech_protect = INFO_CHERRY
        
    elif first_token == "Sarika_siamensis":
        display_info = [" หอยหอยดักดานหรือหอยทากสยาม", " มีชื่อวิทยาศาสตร์คือ", " The Sarika", " siamensis", " โดยจัดอยู่ในวงศ์", " Ariophantidae"]
        speech_protect = INFO_SARIKA
        
    elif first_token == "Lissachatina_fulica":
        display_info = [" หอยหอยทากยักษ์แอฟริกา", " มีชื่อวิทยาศาสตร์คือ", " The Lissachatina", " fulica", " โดยจัดอยู่ในวงศ์", " Achatinidae"]
        speech_protect = INFO_LISSA
        
    elif first_token == "Ovachlamys_fulgens":
        display_info = [" หอยหอยเลขหนึ่ง", " มีชื่อวิทยาศาสตร์คือ", " The Ovachlamys", " fulgens", " โดยจัดอยู่ในวงศ์", " Helicarionidae"]
        speech_protect = INFO_JUMPING
        
    elif first_token == "Bradybaena_similaris":
        display_info = [" หอยหอยสะดือบุ๋ม", " มีชื่อวิทยาศาสตร์ว่า", " The Bradybaena", " similaris", " โดยจัดอยู่ในวงศ์", " Camaenidae"]
        speech_protect = INFO_BRADYBAENA
        
    elif first_token == "Sarika_resplendens":
        display_info = [" หอยหอยสาริกา", " มีชื่อวิทยาศาสตร์คือ", " The Sarika", " resplendens", " โดยจัดอยู่ในวงศ์", " Ariophantidae"]
        speech_protect = INFO_SARIKA
        
    elif first_token == "Succinea_sp":
        display_info = [" หอยหอยอำพัน", " มีชื่อวิทยาศาสตร์คือ", " The Succinea", " sp.", " โดยจัดอยู่ในวงศ์", " Succineidae"]
        speech_protect = INFO_AMBER_SUBULI_MARTEN
        
    elif first_token == "Pomacea_maculata":
        display_info = [" หอยหอยแอปเปิ้ลเกาะ", " มีชื่อวิทยาศาสตร์คือ", " The Pomacea", " maculata", " โดยจัดอยู่ในวงศ์", " Ampullariidae"]
        speech_protect = INFO_CHERRY
