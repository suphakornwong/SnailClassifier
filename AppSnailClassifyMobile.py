...
def main():
    ...
    st.markdown("<h4 style='text-align: center; color: gray;'>งานวิจัยของศุภกร วงษ์เรืองพิบูล</h5>", unsafe_allow_html=True)
    ...
    with tab2:
        ...
        if file_from_camera is not None:
            ...
            st.markdown("<h6 style='text-align: center; color: gray;'>หากต้องการกลับไปใช้รูปจาก gallery กรุณากดปุ่ม Clear photo ก่อน</h5>", unsafe_allow_html=True)
